 ...
 */
@Service
public class DriverCarBindingRelationshipMapperService {
    ...
    public ResponseResult unbind(DriverCarBindingRelationship driverCarBindingRelationship){
        ...
        if(driverCarBindingRelationships.isEmpty()){
            return ResponseResult.fail(CommonStatusEnum.DRIVER_CAR_BIND_NOT_EXISTS.getCode(),CommonStatusEnum.DRIVER_BIND_EXISTS.getValue());
        }
