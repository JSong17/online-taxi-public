...
public class MapDirectionClient {
    ...
    public DirectionResponse direction(String depLongitude, String depLatitude, String destLongitude, String destLatitude){
        /*
        *组装请求调用url
        * efaed2774d2061b3cb946ed78ce441df
        * */
        ...
        //调用高德接口
        log.info("高德地图:路径规划，请求信息：" + urlBuilder.toString());
        ...
        //解析接口
        DirectionResponse directionResponse = paraseDirectionEntity(directionString);
    ...
    private DirectionResponse paraseDirectionEntity(String directionString){
